...
Before beginning this tutorial, you need to insure that your [SAS environment is connected with an R environment](https://communities.sas.com/t5/General-SAS-Programming/Run-R-code-inside-SAS-easily/td-p/210116) so that the R code that SAS calls at the end of this tutorial from the [IML Procedure](#iml) run successfully.
...
The [MEANS procedure](#means) prints the mean of all numeric variables of a [SAS data set](#DATASET), as well as other descriptive statistics.
```{r, echo=6:7}
proc import out = student
datafile = 'C:/Users/class.csv'
dbms = csv replace;
