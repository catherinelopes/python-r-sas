...
[caret](https://www.rdocumentation.org/packages/caret/versions/6.0-76) is an R programming package of tools for training and plotting classification and regression models.

***

## Data Frame {#DataFrame}

An [R Data Frame](https://stat.ethz.ch/R-manual/R-devel/library/base/html/data.frame.html) is a two-dimensional tabular structure with labeled axes (rows and columns), where data observations are represented by rows and data variables are represented by columns.
...
[dplyr](https://cran.r-project.org/web/packages/dplyr/index.html) is an R programming package of tools for workng with [data frame](#DataFrame) like objects.

***

## gbm {#GBM}

[gbm](https://cran.r-project.org/web/packages/gbm/index.html) is an R programming package useful for building and analyzing gradient boosting models.

***

## gdata {#GDATA}

[gdata](https://cran.r-project.org/web/packages/gdata/index.html) is an R programming package of tools useful for data manipulation.

***

## List

An [R list](http://www.r-tutor.com/r-introduction/list) is a sequence of comma-separated objects that need not be of the same type.  Please see the following example of list creation and access:
...
[randomForest](https://cran.r-project.org/web/packages/randomForest/index.html) is an R programming package of tools useful for building and analyzing classification and regression random forest models.

***

## rjson {#RJSON}

[rjson](https://cran.r-project.org/web/packages/rjson/index.html) is an R programming package of tools useful for converting R objects into JSON objects, and JSON objects into R objects.

***

## Series/Array

A series is a one-dimensional data frame, which is also called an [array](https://www.tutorialspoint.com/r/r_arrays.htm) in R.  Please see the following example of array creation and access:
...
[tree](https://cran.r-project.org/web/packages/tree/index.html) is an R programming package of tools useful for building and analyzing classification and regression decision trees.
