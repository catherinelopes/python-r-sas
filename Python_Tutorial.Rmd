...
print(pd.crosstab(index=Results, columns="count"))
```
[preprocessing](http://scikit-learn.org/stable/modules/preprocessing.html) | [SVC](http://scikit-learn.org/stable/modules/generated/sklearn.svm.SVC.html)
...
# Prediction on testing data
prediction = pd.DataFrame()
# 13 is the name of the Target variable
...
print(prediction["sq_diff"].mean())
```
[preprocessing](http://scikit-learn.org/stable/modules/preprocessing.html) | [SVR](http://scikit-learn.org/stable/modules/generated/sklearn.svm.SVR.html)
