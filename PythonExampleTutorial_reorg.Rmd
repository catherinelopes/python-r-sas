...
[PyFlux ARIMA models](http://www.pyflux.com/docs/arima.html#class-description)
...
def initial_seasonal_components(series, slen):
    ...
    return seasonals
def triple_exponential_smoothing_add(series, slen, alpha, beta, gamma, n_preds):
    result = []
...
add_preds = triple_exponential_smoothing_add(vehicles, 12, 0.5731265, 0, 0.7230956, 24)
